    ...
    \begin{frame}
        \begin{columns}[T]
            ...
            \begin{column}{.4\textwidth}
                \begin{columns}
                    \begin{column}{\textwidth}
                        \only<2->{\includegraphics[width=\textwidth]{FirstPixel}}
                    \end{column}
                \end{columns}
                
                \begin{columns}
                    \begin{column}{\textwidth}
                        \only<1->{\includegraphics[width=\textwidth]{contour_def}}
                    \end{column}
                \end{columns}
            ...
            \begin{column}{.1\textwidth}
        	    \only<2->{\includegraphics[width=\textwidth]{ContourCoords}}
            \end{column}
            
            \begin{column}{.5\textwidth}
                \only<1->{Интересующие нас объекты располагаются на пиксельной сетке, значит контур - последовательность пикселей.}
                \newline
                \newline
